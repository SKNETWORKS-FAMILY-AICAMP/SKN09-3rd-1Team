...
7. [수집한 데이터 및 전처리 요약](#7️⃣-수집한-데이터-및-전처리-요약)
8. [DB 연동 구현 코드](#8️⃣-DB-연동-구현-코드)  
9. [테스트 계획 및 결과 보고서](#9️⃣-테스트-계획-및-결과-보고서)
10. [진행 과정 중 프로젝트 개선 노력](#🔟-진행-과정-중-프로젝트-개선-노력)
11. [수행 결과](#*️⃣-수행-결과)
12. [한 줄 회고](#✳️-한-줄-회고)
...
![image.png](attachment:0b7f68ab-ca73-4aca-816a-733c0303bc6a:image.png)
...
![image.png](attachment:2752be1c-0bc9-4c0b-8b7a-49a38a1d1c60:image.png)
...
![image.png](attachment:0fa24a1f-5b45-402a-bab8-91bbd29fc394:image.png)
<br>
